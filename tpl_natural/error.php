...
?>">
	...
	<div class="body">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			...
			<div class="header">
				<div class="header-inner clearfix">
					...
					<div class="header-search pull-right">
						...
						echo $jdoc->getBuffer('modules', 'position-0', array('style' => 'none'));
						?>
					</div>
				</div>
			</div>
			<div class="navigation">
				...
				echo $jdoc->getBuffer('modules', 'position-1', array('style' => 'none'));
				?>
			</div>
			<!-- Banner -->
			<div class="banner">
				<?php echo $jdoc->getBuffer('modules', 'banner', array('style' => 'xhtml')); ?>
			</div>
			<div class="row-fluid">
						...
						<div class="row-fluid">
							...
							<div class="span6">
								<?php if (JModuleHelper::getModule('search')) : ?>
									...
									<?php echo $jdoc->getBuffer('module', 'search'); ?>
								<?php endif; ?>
	...
	<div class="footer">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			<hr />
			<?php echo $jdoc->getBuffer('modules', 'footer', array('style' => 'none')); ?>

			<p class="pull-right"><a href="#top" id="back-top"><?php echo JText::_('TPL_PROTOSTAR_BACKTOTOP'); ?></a></p>
			<p>&copy; <?php echo $sitename; ?> <?php echo date('Y');?></p>
		</div>
	</div>
	<?php echo $jdoc->getBuffer('modules', 'debug', array('style' => 'none')); ?>
</body>
</html>
